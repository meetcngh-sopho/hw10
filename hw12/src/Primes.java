...
public class Primes
{
    ...
    {//Three variable of integer type
    ...
    {
    	//for input the value use scanner class
        Scanner input;
        ...
        //if enter any float or any type in run time throw an exception
        catch(NumberFormatException e)
        {
            System.out.println("Not convert input to integer");
            System.out.println(e.getMessage());
            System.out.println("use 10 default value");
        }        
